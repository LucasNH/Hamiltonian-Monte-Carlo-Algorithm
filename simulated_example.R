...
par(mfrow = c(1, 2))
set.seed(012920)
HMC_beta_samples <- HMC(n_samples = 2000, U_type = "beta", epsilon = 0.01,
                        L = 2, current_q = 0.3, alpha = 50, beta = 50)
hist(HMC_beta_samples, breaks = "scott", freq = FALSE, border = "#ffffff",
     col = "#81ddff", xlab = "Values of HMC Samples",
...
hist(HMC_norm_samples, breaks = "scott", freq = FALSE, border = "#ffffff",
     col = "#f79ee1", xlab = "Values of HMC Samples",
